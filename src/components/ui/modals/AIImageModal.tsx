...
//     try {
//       console.log("🚀 Sending request to generate image (OpenAI DALL-E 3)...");
//       console.log("📝 Prompt:", prompt);
//       console.log("🎨 Style:", style);
//       console.log("📐 Aspect Ratio:", aspectRatio);

//       // Updated API endpoint to use OpenAI route
//       const API_URL = "http://localhost:3000/api/openai/generate-image";
...
//       // Show the revised prompt if available (DALL-E 3 feature)
//       if (data.revisedPrompt) {
//         console.log("📝 DALL-E enhanced your prompt to:", data.revisedPrompt);
//         toast.success(
//           `Image created! DALL-E enhanced your prompt: "${data.revisedPrompt.substring(0, 60)}..."`,
//           { duration: 5000 }
//         );
//       } else {
...
//             Powered by OpenAI DALL-E 3 • Create stunning images from text
//           </p>
//         </div>
...
//               placeholder="e.g., 'A photorealistic golden retriever playing in a sunny park, professional photography, 8k quality, vibrant colors'"
...
//               disabled={isGenerating}
//             >
//               <option value="9:16">📱 9:16 (Vertical - 1024×1792)</option>
//               <option value="16:9">🖥️ 16:9 (Horizontal - 1792×1024)</option>
//               <option value="1:1">⬜ 1:1 (Square - 1024×1024)</option>
//               <option value="4:5">🖼️ 4:5 (Portrait - 1024×1792)</option>
//             </select>
//           </div>
