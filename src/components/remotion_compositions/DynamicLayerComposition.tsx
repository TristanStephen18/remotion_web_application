...
const Icons = {
  // iMessage
  BackChevronBlue: () => <svg width="70" height="70" viewBox="0 0 24 24" fill="none"><path d="M15 19l-7-7 7-7" stroke="#007AFF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  VideoBlue: () => <svg width="66" height="66" viewBox="0 0 24 24" fill="none"><path d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  AppStore: () => <svg width="68" height="68" viewBox="0 0 24 24" fill="#8E8E93"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>,
  CameraGrey: () => <svg width="60" height="60" viewBox="0 0 24 24" fill="none"><path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z" stroke="#8E8E93" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><circle cx="12" cy="13" r="4" stroke="#8E8E93" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  MicGrey: () => <svg width="56" height="56" viewBox="0 0 24 24" fill="none"><path d="M12 1a3 3 0 00-3 3v8a3 3 0 006 0V4a3 3 0 00-3-3z" stroke="#8E8E93" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M19 10v2a7 7 0 01-14 0v-2" stroke="#8E8E93" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><line x1="12" y1="19" x2="12" y2="23" stroke="#8E8E93" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><line x1="8" y1="23" x2="16" y2="23" stroke="#8E8E93" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  
  // WhatsApp
  BackArrowWhite: () => <svg width="60" height="60" viewBox="0 0 24 24" fill="none"><path d="M19 12H5M12 19l-7-7 7-7" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  VideoWhite: () => <svg width="58" height="58" viewBox="0 0 24 24" fill="none"><path d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  PhoneWhite: () => <svg width="54" height="54" viewBox="0 0 24 24" fill="none"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" fill="white"/></svg>,
  PlusGrey: () => <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#8E8E93" strokeWidth="2"><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>,
  MicWhite: () => <svg width="48" height="48" viewBox="0 0 24 24" fill="none"><path d="M12 1a3 3 0 00-3 3v8a3 3 0 006 0V4a3 3 0 00-3-3z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M19 10v2a7 7 0 01-14 0v-2" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><line x1="12" y1="19" x2="12" y2="23" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><line x1="8" y1="23" x2="16" y2="23" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,

  // Instagram (SCALED UP)
  BackArrowBlack: () => <svg width="60" height="60" viewBox="0 0 24 24" fill="none"><path d="M19 12H5M12 19l-7-7 7-7" stroke="black" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  VideoBlack: () => <svg width="60" height="60" viewBox="0 0 24 24" fill="none"><path d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  PhoneBlack: () => <svg width="56" height="56" viewBox="0 0 24 24" fill="none"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" stroke="black" strokeWidth="2" fill="none"/></svg>,
  InfoBlack: () => <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>,
  ImageSquare: () => <svg width="54" height="54" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>,
  Sticker: () => <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2"><path d="M12 2a10 10 0 1 0 10 10 10 10 0 0 0-10-10z"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>,

  // Messenger
  PlusBlue: () => <svg width="52" height="52" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#0084FF" /><path d="M12 8v8M8 12h8" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  PhonePurple: () => <svg width="56" height="56" viewBox="0 0 24 24" fill="none"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" fill="#A855F7"/></svg>,
  VideoPurple: () => <svg width="58" height="58" viewBox="0 0 24 24" fill="none"><path d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" fill="#A855F7"/></svg>,
};
...
const ChatInterface: React.FC<{ style: ChatStyle; name: string; avatar?: string }> = ({ style, name, avatar }) => {
  ...
  const renderHeader = () => {
    ...
    if (style === "imessage") {
      return (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", marginBottom: "5px" }}>
          <div style={{ display: "flex", alignItems: "center", color: "#007AFF", gap: '8px' }}>
            <Icons.BackChevronBlue />
            <span style={{ fontSize: "52px", fontWeight: "400", letterSpacing: "-0.5px" }}>24</span>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: "12px" }}>
            <div style={{ width: "95px", height: "95px", borderRadius: "50%", background: "#ccc", marginBottom: "10px", overflow: "hidden" }}>
                <img src={displayAvatar} style={{ width: "100%", height: "100%", objectFit: "cover"}} />
            </div>
            <span style={{ fontSize: "32px", fontWeight: "600", color: "black" }}>{name} <span style={{color: '#8E8E93', fontWeight: '400'}}>&gt;</span></span>
          </div>
    ...
    if (style === "whatsapp") {
      return (
        <div style={{ display: "flex", alignItems: "center", gap: "16px", width: "100%", paddingBottom: "16px", marginTop: paddingTop }}>
          <Icons.BackArrowWhite />
          <div style={{ width: "90px", height: "90px", borderRadius: "50%", background: "#ccc", overflow: "hidden" }}>
             <img src={displayAvatar} style={{ width: "100%", height: "100%", objectFit: "cover"}} />
          </div>
          <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
            <span style={{ fontSize: "42px", fontWeight: "500", color: "white" }}>{name}</span>
            <span style={{ fontSize: "36px", color: "rgba(255,255,255,0.8)" }}>online</span>
          </div>
    ...
    if (style === "instagram") {
        return (
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", paddingBottom: "16px", marginTop: paddingTop }}>
              <div style={{display: 'flex', alignItems: 'center', gap: '22px'}}>
                 ...
                 <div style={{ display: "flex", flexDirection: "column" }}>
                    <span style={{ fontSize: "44px", fontWeight: "600", color: "black" }}>{name}</span>
                    <span style={{ fontSize: "22px", color: "#8E8E93" }}>Active 2h ago</span>
                 </div>
              </div>
    ...
    return (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", paddingBottom: "16px", marginTop: paddingTop }}>
            <div style={{ display: "flex", alignItems: "center", gap: "22px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    <span style={{ fontSize: "42px", fontWeight: "700", color: "black" }}>{name}</span>
                    <span style={{ fontSize: "26px", color: "#8E8E93" }}>Active 2m ago</span>
                </div>
            </div>
  ...
  const renderFooter = () => {
    if (style === "imessage") {
      return (
        <div style={{ display: 'flex', alignItems: 'center', width: '100%' }}>
          <div style={{ padding: "12px", background: "#E9E9EB", borderRadius: "50%", marginRight: "16px" }}>
            <Icons.CameraGrey />
          </div>
          ...
          <div style={{ 
            flex: 1, height: "90px", border: "1px solid #C7C7CC", borderRadius: "45px", 
            display: "flex", alignItems: "center", padding: "0 24px", color: "#C7C7CC", 
            fontSize: "36px", background: "white" 
          }}>
            iMessage
          </div>
    ...
    if (style === "whatsapp") {
        return (
            <div style={{ display: 'flex', alignItems: 'center', width: '100%' }}>
              <div style={{ paddingRight: '16px' }}><Icons.PlusGrey /></div>
              <div style={{ flex: 1, height: "90px", background: "white", borderRadius: "45px", display: "flex", alignItems: "center", padding: "0 24px", border: '1px solid #f0f0f0' }}>
                 <span style={{ fontSize: "36px", color: "#C7C7CC", flex: 1 }}>Message</span>
                 <div style={{display:'flex', gap:'22px'}}>
                    <Icons.CameraGrey />
                 </div>
              </div>
              <div style={{ width: "95px", height: "95px", background: "#00a884", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", marginLeft: "16px", boxShadow: "0 2px 4px rgba(0,0,0,0.2)" }}>
                 <Icons.MicWhite />
              </div>
            </div>
        )
    ...
    if (style === "instagram") {
        return (
            <div style={{ width: "100%", height: "100px", background: "#f0f0f0", borderRadius: "50px", display: "flex", alignItems: "center", padding: "0 24px" }}>
                <div style={{ width: "70px", height: "70px", background: "#3b82f6", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", marginRight: "18px" }}>
                    <svg width="44" height="44" viewBox="0 0 24 24" fill="white"><path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/></svg>
                </div>
                <span style={{ fontSize: "38px", color: "#8E8E93", flex: 1, fontWeight: 400 }}>Message...</span>
    ...
    return (
        <div style={{ display: "flex", alignItems: "center", width: "100%", gap: "24px" }}>
            ...
            <Icons.ImageSquare />
            <Icons.MicGrey />
            <div style={{ flex: 1, height: "90px", background: "#f0f0f0", borderRadius: "45px", display: "flex", alignItems: "center", padding: "0 24px" }}>
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={bubbleStyle}>
        {layer.isTyping ? (
           <div style={{ display: 'flex', gap: '10px', padding: '14px 8px', alignItems: 'center' }}>
              {[0, 1, 2].map(i => (
                <div key={i} style={{
          ...
          <>
            ...
            {layer.chatStyle === 'whatsapp' && (
              <div style={{ 
                float: 'right', marginLeft: '16px', marginTop: '12px',
                display: 'flex', alignItems: 'center', gap: '8px', height: '20px'
              }}>
                <span style={{ fontSize: '20px', color: 'rgba(0,0,0,0.45)' }}>10:42</span>
                {layer.isSender && (
...
const TextLayerComponent: React.FC<{ layer: TextLayer; relativeFrame: number; fps: number; width: number; height: number }> = ({ layer, relativeFrame, fps, height }) => {
  ...
  const shouldHighlight = (word: string): boolean => {
    ...
    const isHighlighted = layer.highlightWords.some(hw => hw.toLowerCase() === cleanWord);
    
    // Debug logging (remove after testing)
    if (isHighlighted) {
      console.log(`Word "${word}" (cleaned: "${cleanWord}") matched in:`, layer.highlightWords);
    }
  ...
  if (layer.highlightWords && layer.highlightWords.length > 0) {
    console.log('TextLayer rendering with highlightWords:', layer.highlightWords);
  }
...
export const DynamicLayerComposition: React.FC<DynamicCompositionProps> = ({
  ...
  const getChatBackground = (style: ChatStyle | null) => {
    ...
    switch (style) {
      case "whatsapp": return "linear-gradient(180deg, #128C7E 0%, #075E54 100%)";
      case "imessage": return "linear-gradient(180deg, #5AC8FA 0%, #007AFF 100%)"; 
      case "instagram": return "linear-gradient(180deg, #F58529 0%, #DD2A7B 50%, #8134AF 100%)";
      case "messenger": return "linear-gradient(180deg, #00B2FF 0%, #006AFF 100%)";
